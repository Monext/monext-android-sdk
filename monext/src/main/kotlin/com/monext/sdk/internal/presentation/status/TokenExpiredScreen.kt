...
@Composable
internal fun TokenExpiredScreen(onExit: () -> Unit) {
    ...
    Column {
        Column(
            ...
            Text(
                stringResource(R.string.token_expired_message),
                modifier = Modifier.testTag("expîred_header"),
...
@Preview
@Composable
internal fun TokenExpiredScreenPreview() {
    PreviewWrapper {
        TokenExpiredScreen {}
    }
}