...
#--------------------------
#--------------------------
# Pro Guard Monext Online
#--------------------------
# Garde les classes principales publiques du SDK en clair
-keep public class com.monext.sdk.PaymentBox {
    public <methods>;  # Toutes les méthodes publiques
    public <fields>;   # Tous les champs publics
}
-keep public class com.monext.sdk.PaymentSheet {
    public <methods>;  # Toutes les méthodes publiques
    public <fields>;   # Tous les champs publics
}

# Garde TOUT dans ces classes (constructeurs, méthodes, champs)
...
# ============================================
# Ces attributs sont nécessaires pour la réflexion et le debugging
# Garde les annotations (utilisées par Retrofit, Gson, etc.)
-keepattributes *Annotation*
# Garde les signatures génériques (nécessaire pour Gson/Retrofit avec types génériques)
-keepattributes Signature
# Garde les exceptions (pour les stack traces lisibles)
-keepattributes Exceptions
# Garde les classes internes (souvent utilisées dans Android)
-keepattributes InnerClasse
# Garde les méthodes englobantes (pour les classes anonymes)
-keepattributes EnclosingMethod

# ============================================
# SECTION : KOTLINX SERIALIZATION
# Garde les annotations de serialization
-keepattributes RuntimeVisibleAnnotations,RuntimeVisibleParameterAnnotations
# Garde les classes annotées avec @Serializable
-keepclassmembers @kotlinx.serialization.Serializable class ** {
    *** Companion;
    *** INSTANCE;
    kotlinx.serialization.KSerializer serializer(...);
}
# Garde les serializers générés
-keep class **$$serializer { *; }
# Garde les @Serializable
...
# Garde les ViewModels
-keep class * extends androidx.lifecycle.ViewModel { *; }

# ============================================
# SECTION : GOOGLE PAY (play-services-wallet)
...
# ============================================
# SECTION : KOTLIN
# Ignore les warnings Kotlin
-dontwarn kotlin.**
# Garde les métadonnées Kotlin (pour la réflexion)
-keep class kotlin.Metadata { *; }
# Garde les mappings when (générés par le compilateur Kotlin)
-keepclassmembers class **$WhenMappings {
    <fields>;
}
# Garde les classes compagnon (companion objects)
...
# Cette règle supprime complètement les appels de log du bytecode final
# Très important pour la sécurité : pas de logs en production !
-assumenosideeffects class android.util.Log {
    public static boolean isLoggable(java.lang.String, int);
    public static int v(...);  # Verbose
    public static int i(...);  # Info
    public static int w(...);  # Warning
    public static int d(...);  # Debug
    public static int e(...);  # Error
    public static int wtf(...); # What a Terrible Failure
}

# SLF4J (tu utilises slf4j-api)
...
# Supprime aussi les println (si vous en avez)
...
# Nombre de passes d'optimisation (plus = plus optimisé mais plus lent)
-optimizationpasses 5
# Ne pas utiliser des noms de classes avec casse mixte après obfuscation
-dontusemixedcaseclassnames
# Ne pas ignorer les bibliothèques non publiques
-dontskipnonpubliclibraryclasses
# Ne pas pré-vérifier (non nécessaire pour Android)
-dontpreverify
# Mode verbose pour le debugging des règles ProGuard
-verbose
# Optimisations à appliquer
# ! signifie "ne pas appliquer"
-optimizations !code/simplification/arithmetic,!field/*,!class/merging/*

# ============================================
# SECTION : DEBUGGING -Garde les infos pour analyser les crash reports
# Garde les numéros de ligne (pour les stack traces)
# IMPORTANT : Permet de débugger même après obfuscation
-keepattributes SourceFile,LineNumberTable
# Renomme le fichier source pour cacher le vrai nom
-renamesourcefileattribute SourceFile
